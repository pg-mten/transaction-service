...
import { FeePurchaseService } from '../fee/purchase/fee-purchase.service';
import { CreatePurchaseTransactionDto } from './dto/create-purchase-transaction.dto';
import { PurchasingFeeDto } from '../fee/purchase/dto/purchashing-fee.dto';
...
export class TransactionPurchaseService {
  constructor(
    ...
    private feePurchaseService: FeePurchaseService,
  ) {}
